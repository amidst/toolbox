 ...
 */
public class DataSetLoaderTest extends TestCase {

    public static void test1() throws Exception {

        DataFlink<DataInstance> dataFlink = DataSetLoader.loadData("./datasets/dataFlink/test_not_modify/SmallDataSet.arff");
