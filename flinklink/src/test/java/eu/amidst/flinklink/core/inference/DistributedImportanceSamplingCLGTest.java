...
public class DistributedImportanceSamplingCLGTest extends TestCase {

    final static double probThreshold = 0.1;
    ...
    public static void test1() throws Exception {
        ...
        DistributedImportanceSamplingCLG importanceSampling = new DistributedImportanceSamplingCLG();
        ...
        assertEquals(postA.getProbabilities()[0], 0.9, probThreshold);
        assertEquals(postB.getProbabilities()[0], 0.7, probThreshold);
    ...
    public static void test2() throws Exception {
        ...
        assertEquals(0.75, postA.getProbabilities()[0], probThreshold);
    ...
    public static void test3() throws Exception {
        ...
        assertEquals(postA.getProbabilities()[0], 0.5, probThreshold);
        assertEquals(postB.getProbabilities()[0], 0.5, probThreshold);
        assertEquals(postC.getProbabilities()[0], 0.6, probThreshold);
    ...
    public static void test4() throws Exception {
        ...
        assertEquals(postA.getProbabilities()[0], 0.625, probThreshold);
        assertEquals(postB.getProbabilities()[0], 0.333, probThreshold);
    ...
    public static void test5() throws Exception {
        ...
        assertEquals(0.5, postA.getProbabilities()[0], probThreshold);
        assertEquals(2.5, postB.getMean(), 0.8);
        assertEquals(7.25, postB.getVariance(),  3);
    ...
    public static void test6() throws Exception {
        ...
        assertEquals(0.333, postA.getProbabilities()[0], probThreshold);
        assertEquals(0, postB.getMean(), 0.2);
        assertEquals(2.666, postB.getVariance(), 2);
    ...
    public static void test7() throws Exception {
        ...
        assertEquals(0.333, postB.getParameters()[0], probThreshold);
        assertEquals(0, postB.getParameters()[1], 0.1);
        assertEquals(1, postB.getParameters()[2], 0.5);

        assertEquals(0.666, postB.getParameters()[3], probThreshold);
        assertEquals(10, postB.getParameters()[4], 0.1);
        assertEquals(1, postB.getParameters()[5], 0.5);
