...
public class ForTesting3Attributes implements Attributes {
    ...
    private final Attribute TWO_NAMES = new Attribute(1, "TWO NAMES", "NA", Kind.INTEGER);
    private final Attribute THREE_NAMES_HERE = new Attribute(0, "THREE NAMES HERE", "NA", Kind.REAL);
