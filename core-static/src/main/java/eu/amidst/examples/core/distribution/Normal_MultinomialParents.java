...
import eu.amidst.examples.core.exponentialfamily.EF_Normal;
...
public class Normal_MultinomialParents extends ConditionalDistribution {
    ...
    public String toString() {
        ...
        for(int i=0;i<getNumberOfParentAssignments();i++){
            ...
            str.append(this.getNormal(i).toString()+" | "+parentAssignment.toString(this.getConditioningVariables()) +"\n");
        }
        return str.toString();
    }
    ...
    public boolean equalDist(Distribution dist, double threshold) {
        if (dist.getClass().getName().equals("Normal_MultinomialParents"))
