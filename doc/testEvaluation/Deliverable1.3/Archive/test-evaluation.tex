...
\todo{HL says: I'm still not really not sure what we need this for. What exactly can we test? Say more.}
...
\todo{Sigve says: Include a discussion of statistical interpretation of loss functions on stationary data.  Dependence between timesteps is essential. Is this a problem? What opportunities do we have with evolving loss? Maybe nothing, but worth reflecting on.}
...
\todo{Sigve says: Discuss stationary explanatory variables with consept drift versus non stationary explanatory variables with concept drift.}

\todo{Sigve says: Add a section on drift detection with prequential AUC and prequential loss?}
