...
It is also important to note that most streams are not stationary.  Problems that involve \emph{consept-drift} are problems when data is drifting.  In \cite{Gam13}, it was suggested to use prequental loss with forgetting mechanisms to compensate for concept drift and in \cite{Brz14}, the prequential AUC with a forgetting mechanism is proposed.  
