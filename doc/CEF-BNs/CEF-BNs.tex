...
&-& 
\left(\ln{\sigma} - \thb_{\beta_0\beb} \Y - \thb_{\beb\beb}\Y\Y -\frac{\theta_{\beta_0}}{4\theta_{\mbox{-}1}}\right) - \tfrac{1}{2}\ln{(2\pi)}\\
\end{eqnarray*}
...
{Y^i}^2\\
\end{pmatrix}\\
&+& \thb_{\beta_0\beb}'Y' + 2\thb_{\beb}'XY'  + \thb_{\beb\beb}'Y'Y' + \theta_{\beta_0}X + \theta_{\mbox{-}1}XX \\
&-& \left( \frac{\theta_{\beta_0}}{4\theta_{\mbox{-}1}} \right) - \tfrac{1}{2}\ln{(2\pi)}
\end{eqnarray*}
