...
&-& 
\left(-0.5\ln{(-2\theta_{\mbox{-}1})} - \thb_{\beta_0\beb} \Y - \thb_{\beb\beb}\Y\Y -\frac{\theta_{\beta_0}^2}{4\theta_{\mbox{-}1}}\right) - \tfrac{1}{2}\ln{(2\pi)}\\
\end{eqnarray*}
...
&=&
\begin{pmatrix}
\thb_{\beta_0\beb}^i + 2\thb_{\beb}^iX + 2\thb_{\beb\beb}^{'T}\Y\Y \\
\thb_{\beb\beb}^{ii} 
\end{pmatrix}^T
\begin{pmatrix}
Y^i\\
...
where $\thb_{\beb\beb}' = \thb_{\beb\beb}$ with $\thb_{\beb\beb}^i = 0$, $\thb_{\beb\beb}^{i\cdot} = 0$  and $\thb_{\beb\beb}^{\cdot i} = 0$ ,\\
where $\thb_{\beb\beb}^{'} = \thb_{\beb\beb}^{i}$ with $ \thb_{\beb\beb}^{ii} = 0$.\\
