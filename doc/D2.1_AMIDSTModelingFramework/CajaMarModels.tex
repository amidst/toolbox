...
\begin{figure}[h]
  ...
  \end{tabular}
    \caption{\label{fig:cajamarCorr}Example of correlograms for two predictive variables.  The x-axis represents the lag $v$ or time difference, and the y-axis represents the sample autocorrelation coefficient of lag $v$, denoted $\hat{\rho_v}$ (see Section~\ref{SubSection:CorrelogramsAndPartialCorrelograms} for more details).}
\end{figure}
