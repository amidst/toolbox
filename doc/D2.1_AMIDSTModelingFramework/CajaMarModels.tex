...
%As in any standard evaluation data set in supervised classification settings, each record contains the values of the predictive variables for a considered customer. 
