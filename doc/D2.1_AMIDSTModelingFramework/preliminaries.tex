...
\textcolor{blue}{//Indicate that a more detailed revision of the state-of-the-art in methods for modelling complex empirical distributions can be found in deliverables 3.1 (about inference in hybrid and dynamic models) and 4.2 (about learning in the context of the AMIDST framework). \\}
\textcolor{blue}{//Emphasize the current limitations of these for dynamic models and streaming data.}
