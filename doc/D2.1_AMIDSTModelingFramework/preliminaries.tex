...
A more detailed revision of the state-of-the art in methods for modeling complex empirical distributions can be found in future Deliverables 3.1 (about inference in hybrid and dynamic models) and 4.2. (about learning in the context of the AMIDST framework).
