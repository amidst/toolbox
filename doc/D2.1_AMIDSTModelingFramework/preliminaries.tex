...
%Unless explicitly mentioned, the considered DBNs in AMIDIn almost all the problems in AMIDST, the DBNs model that will 
...
%By considering the prior probability distribution at time $0$, $P(\bm X_0)$,
