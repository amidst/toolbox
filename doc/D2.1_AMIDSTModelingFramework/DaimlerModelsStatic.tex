...
This section is divided into three main sections, one for each of the three use-case providers. Each of these sections begins with a subsection explaining state-of-the-art for the various application scenarios defined in Deliverable 1.2. The subsequent subsections address then the different application scenarios within the AMIDST project and introduce their corresponding use-case-specific probabilistic graphical model classes. These model classes will, in turn, form the basis for the general AMIDST modelling framework presented later in Section \ref{section:AMIDSTmodelClass}. Finally, the last subsections include discussions and directions for possible further model extensions for each of the use-case providers.  
...
\caption{\label{Figure:DaimlerLE} A static OOBN fragment for the lateral evidence hypothesis.}
\end{center}
\end{figure}
