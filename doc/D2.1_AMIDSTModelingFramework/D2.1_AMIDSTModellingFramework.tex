...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{|p{13mm}| p{18mm}| X | X |} \hline
    ...
    v1.0 & 29/09/2014~ & Hanen Borchani, Antonio Fern\'andez, Odd E. Gundersen, Sigve Hovda, Helge Langseth, Anders L. Madsen, Ana M. Mart\'inez, Ram\'on Mart\'inez, Andr\'es Masegosa, Thomas D. Nielsen, Antonio Salmer\'on, Frode S{\o}rmo, Galia Weidl & Final version of document  \\ \hline
  \end{tabularx}
\end{table}
