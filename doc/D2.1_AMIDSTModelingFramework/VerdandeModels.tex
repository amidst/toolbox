...
As has been pointed out in Deliverable D1.2 \cite{Fer14b}, there are three main tasks that have to be addressed for Verdande Technology use case:
...
\item Shift$_t$  generates a  chain of variables used for determining when   a formation-change actually occurs. It remains to be further explored if consecutive Shift variables should be connected or not. It has two parents, namely  FormationNo$_{t-1}$ and  FormationNo$_t$. 
