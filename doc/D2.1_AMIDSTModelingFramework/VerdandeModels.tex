...
{\bf Sigve will add some oil-lingo to explain why this is a problem worth looking at}
...
{\bf Do we need the input-output-KF? What about the structure of the analysis for the $\ell_t$-terms?}
