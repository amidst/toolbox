...
\begin{figure}
  ...
  \renewcommand{\arraystretch}{0.02}
    \begin{tabular}{cc}
    %\includegraphics[width=60mm]{figures/DaimlerEGOplotSerie10Vel.pdf}&
    %\includegraphics[width=60mm]{figures/DaimlerEGOcontourSerie10Vel.pdf}\\
  \end{tabular}
