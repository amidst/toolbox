...
\begin{itemize}
\item From moment to natural parameters:
...
\mu_X &=& m_X\\
\mu_Y &=& m_Y\\
\Sigma_{XX} &=&  m_{X^2} - m_X^2\\
\Sigma_{YY} &=&  m_{Y^2} - m_Y^2\\
\Sigma_{XY} &=&  m_{XY} - m_Xm_Y\\
\Sigma_{YX} &=&  m_{YX} - m_Ym_X
\end{eqnarray*}

\item SECOND STEP:
\begin{eqnarray*}
\beta_0 &=& \mu_X - \Sigma_{XY}\Sigma^{-1}_{YY}\mu_X\\
 &=& m_X + \frac{m_X m_Y^2 - m_{XY}m_Y}{m_{Y^2} - m_Y^2}\\
\beta   &=& \Sigma_{XY}\Sigma^{-1}_{YY} \\
 &=& \frac{m_{XY} - m_Xm_Y}{m_{Y^2} - m_Y^2}\\
\sigma^2 &=& \Sigma_{XX} - \Sigma_{XY}\Sigma^{-1}_{YY}\Sigma_{YX}\\
 &=& m_{X^2} - m_X^2 + \frac{m_Ym_X(m_{XY}+m_{YX}-m_Xm_Y)-m_{XY}m_{YX}}{m_{Y^2} - m_Y^2}
\end{eqnarray*}
\end{itemize}
