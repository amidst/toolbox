 ...
 */
public class DataOnMemoryListContainerSerializable<E extends DataInstance> implements DataOnMemory<E>, Serializable {
     ...
     */
    public DataOnMemoryListContainerSerializable(Attributes attributes_){
     ...
     */
    public DataOnMemoryListContainerSerializable(Attributes attributes_, List<E> instanceList){
        this.instanceList=new ArrayList();
