...
public class EF_SparseMultinomialTest extends TestCase {
    ...
    public static void test1() {
        ...
        EF_SparseMultinomial dist = new EF_SparseMultinomial(variables.newMultionomialVariable("A", 10));
    ...
    public static void test3() {
        ...
        EF_SparseMultinomial dist = new EF_SparseMultinomial(variables.newMultionomialVariable("A", 10));
        EF_Multinomial distM = new EF_Multinomial(variables.newMultionomialVariable("AM", 10));
