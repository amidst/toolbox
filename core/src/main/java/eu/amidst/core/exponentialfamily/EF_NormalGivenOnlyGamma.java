...
/**
 *
 * This class extends the abstract class {@link EF_ConditionalDistribution} and defines a conditional Normal distribution given Gamma parameter
 ...
 */
public class EF_NormalGivenOnlyGamma extends EF_ConditionalDistribution{
     ...
     */
    public EF_NormalGivenOnlyGamma(Variable var_, double meanValue, Variable gamma){
        this.var = var_;
        ...
        if (!var.isNormalParameter())
            throw new UnsupportedOperationException("Creating a Normal-Inverse-Gamma EF distribution for a non-gaussian parameter child variable.");
    ...
    public double getExpectedLogNormalizer(Map<Variable, MomentParameters> momentParents) {
        double meansquare = meanValue*meanValue;
    ...
    public NaturalParameters getExpectedNaturalFromParents(Map<Variable, MomentParameters> momentParents) {
        ...
        NaturalParameters naturalParameters = new EF_NormalParameter.ArrayVectorParameter(2);

        naturalParameters.set(0,meanValue);
