 ...
 */
public class EF_NormalParameterv2 extends EF_UnivariateDistribution {
     ...
     */
    public EF_NormalParameterv2(Variable var1) {
    ...
    public EF_UnivariateDistribution deepCopy(Variable var) {
        ...
        EF_NormalParameterv2 copy = new EF_NormalParameterv2(var);
