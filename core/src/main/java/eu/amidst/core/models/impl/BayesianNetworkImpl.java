 ...
 *
 */
public class BayesianNetworkImpl implements BayesianNetwork, Serializable {
     ...
     */
    public BayesianNetworkImpl(DAG dag) {
        this.dag = dag;
     ...
     */
    public BayesianNetworkImpl(DAG dag, List<ConditionalDistribution> dists) {
        this.dag = dag;
