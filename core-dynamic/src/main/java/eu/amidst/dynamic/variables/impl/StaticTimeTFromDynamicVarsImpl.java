 ...
 */
public class StaticTimeTFromDynamicVarsImpl implements Variables {

    DynamicVariables dynamicVariables;

    public StaticTimeTFromDynamicVarsImpl(DynamicVariables dynamicVariables) {
    ...
    public Variable getVariableById(int varID) {
        if (varID>this.dynamicVariables.getNumberOfVars())
            return this.dynamicVariables.getVariableById(varID-this.dynamicVariables.getNumberOfVars());
        return this.dynamicVariables.getVariableById(varID);
    }

    @Override
    public Variable getVariableByName(String name) {
        return this.dynamicVariables.getVariableByName(name);
    }

    @Override
    public int getNumberOfVars() {
        return 2*this.dynamicVariables.getNumberOfVars();
    }
    ...
    public List<Variable> getListOfVariables() {
        return this.dynamicVariables.getListOfDynamicAndInterfaceVariables();
    }
