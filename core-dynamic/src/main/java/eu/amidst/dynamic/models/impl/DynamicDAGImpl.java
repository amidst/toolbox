 ...
 */
public class DynamicDAGImpl implements DynamicDAG, Serializable {
    ...
    public DynamicDAGImpl(DynamicVariables dynamicVariables1) {
    ...
    public boolean equals(Object o) {
        ...
        DynamicDAGImpl dyndag = (DynamicDAGImpl) o;
    ...
    public DAG toDAGTimeT(){
        ...
        DAG dag = ModelFactory.newDAG(staticVariables);
