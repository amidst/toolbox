...
import eu.amidst.flinklink.core.learning.parametric.ParallelMaximumLikelihood2;
import org.apache.flink.api.java.ExecutionEnvironment;

/**
 * Created by Hanen on 07/10/15.
 */
public class ParallelMLE2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //DataFlink<DataInstance> data = DataFlinkLoader.loadDataFromFolder(env,"hdfs:///tmp.arff", false);
