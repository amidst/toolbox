...
public class EvaluatePrequentialRegression extends RegressionMainTask {
    ...
    public ClassOption learnerOption = new ClassOption("learner", 'l',
            "Classifier to train.", Regressor.class, "trees.FIMTDD");
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        RegressionPerformanceEvaluator evaluator = (RegressionPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
