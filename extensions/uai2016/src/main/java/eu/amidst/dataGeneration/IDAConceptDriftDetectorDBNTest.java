...
import eu.amidst.flinklink.core.conceptdrift.IDAConceptDriftDetectorDBN;
 ...
 */
public class IDAConceptDriftDetectorDBNTest{
    ...
    public static void testUpdateN_IDAData() throws Exception {
        ...
        DataFlink<DynamicDataInstance> data0 = DataFlinkLoader.loadDynamicDataFromFolder(env,
                "./extensions/uai2016/doc-experiments/dataGenerationForFlink/IDAlikeData/withIndex/MONTH1.arff", false);
        ...
        for (int i = 1; i < NMONTHS; i++) {
            ...
            DataFlink<DynamicDataInstance> dataNew = DataFlinkLoader.loadDynamicDataFromFolder(env,
                    "./extensions/uai2016/doc-experiments/dataGenerationForFlink/IDAlikeData/withIndex/MONTH" +
                            (i+1) + ".arff", false);
