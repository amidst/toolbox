 ...
 */
public class MixtureModelDistributedVMPv1 {

    static Logger logger = LoggerFactory.getLogger(MixtureModelDistributedVMPv1.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        //        "550", "1000", "0.00001", "100", "1", "200", "0", "1", "4"};
        ...
        parallelVB.setIdenitifableModelling(new IdentifiableIDAUAIModelLocalHidden(nStates));
