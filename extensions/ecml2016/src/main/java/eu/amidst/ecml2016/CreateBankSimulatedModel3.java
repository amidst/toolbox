...
public class CreateBankSimulatedModel3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        p11.getNormal_NormalParentsDistribution(0).setCoeffForParent(overallExpenses.getInterfaceVariable(),1.1);
        p11.getNormal_NormalParentsDistribution(0).setVariance(0.5);

        p11.getNormal_NormalParentsDistribution(1).setIntercept(0);
        p11.getNormal_NormalParentsDistribution(1).setCoeffForParent(overallExpenses.getInterfaceVariable(),0.8);
        p11.getNormal_NormalParentsDistribution(1).setVariance(0.5);

        p11.getNormal_NormalParentsDistribution(2).setIntercept(-5);
        p11.getNormal_NormalParentsDistribution(2).setCoeffForParent(overallExpenses.getInterfaceVariable(),1.1);
        p11.getNormal_NormalParentsDistribution(2).setVariance(1);

        p11.getNormal_NormalParentsDistribution(3).setIntercept(-5);
        p11.getNormal_NormalParentsDistribution(3).setCoeffForParent(overallExpenses.getInterfaceVariable(),0.8);
