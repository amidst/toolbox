...
public class PosteriorDistributionsComparisonToHugin {
    ...
    public static void main(String[] args) {
        ...
        double probKeepingClassState = 0.6;
        ...
        BayesianNetwork model_2grouped = dynMAP.getMergedClassVarModels().get(0);
...
//                System.out.println("HUGIN Evidence set");
                ...
                Domain huginBN_2grouped = BNConverterToHugin.convertToHugin(model_2grouped);
...
//                System.out.println("HUGIN Evidence set");
                ...
                System.out.println("POSTERIOR DISTRIBUTIONS FOR 2-GROUPED CLASS VARIABLES");
                totalDivergenceIS = 0;
                totalDivergenceVMP = 0;
                for (int i = 0; i < model_2grouped.getVariables().getListOfVariables().stream().filter(variable -> variable.getName().contains("GROUPED")).count(); i++) {

                    Variable ungroupedClassVar = model_2grouped.getVariables().getVariableById(i);
                    System.out.println("Posterior Marginal for " + ungroupedClassVar.getName());
