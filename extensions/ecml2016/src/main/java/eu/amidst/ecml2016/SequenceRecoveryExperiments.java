 ...
 */
public class SequenceRecoveryExperiments {
    ...
    public static void main(String[] args) {
        ...
        int seedModel = 173472;
        Random randomModel = new Random(seedModel);

        int seedEvidence = 2936;
...
//                    if (evidence.get(k).getTimeID() % 3 != 0) {
...
//                }
                ...
                if (saveModels) {
                    try {
                        BNConverterToHugin.convertToHugin(unfoldedStaticModel1).saveAsNet(outputDirectory + "model_" + i + "_ungrouped.net");
                    } catch (ExceptionHugin e) {
...
//                System.out.println("\n\n");
                ...
                if (saveModels) {
                    try {
                        BNConverterToHugin.convertToHugin(unfoldedStaticModel3).saveAsNet(outputDirectory + "model_" + i + "_2grouped_0.net");
                        BNConverterToHugin.convertToHugin(unfoldedStaticModel4).saveAsNet(outputDirectory + "model_" + i + "_2grouped_1.net");
                    } catch (ExceptionHugin e) {
                        System.out.println(e.toString());
                    }
                }
...
//                System.out.println("\n\n");
                ...
                final BayesianNetwork unfoldedStaticModel7 = dynMAP.getMergedClassVarModels().get(0);
                final BayesianNetwork unfoldedStaticModel8 = dynMAP.getMergedClassVarModels().get(1);
                final BayesianNetwork unfoldedStaticModel9 = dynMAP.getMergedClassVarModels().get(2);


                if (saveModels) {
                    try {
                        BNConverterToHugin.convertToHugin(unfoldedStaticModel7).saveAsNet(outputDirectory + "model_" + i + "_3grouped_0.net");
                        BNConverterToHugin.convertToHugin(unfoldedStaticModel8).saveAsNet(outputDirectory + "model_" + i + "_3grouped_1.net");
                        BNConverterToHugin.convertToHugin(unfoldedStaticModel9).saveAsNet(outputDirectory + "model_" + i + "_3grouped_2.net");
                    } catch (ExceptionHugin e) {
                        System.out.println(e.toString());
                    }
                }
