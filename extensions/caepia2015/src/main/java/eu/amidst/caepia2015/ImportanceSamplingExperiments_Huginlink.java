 ...
 */
public class ImportanceSamplingExperiments_Huginlink {
...
//            double execTimeVMP = (double) (timeStopVMP - timeStartVMP) / 1000000000.0;
            ...
            System.out.println(importanceSampling.weightedSampleList);
            ...
            System.out.println(posteriorHUGIN.toString());
...
//            if (probISexact==0 || Double.isNaN(probISexact)) {
//                continue;
//            }
//            else {
//                k++;
//            }
        ...
        */
        ...
        double meanErrorVMP = IntStream.range(0, REP).mapToDouble(kk-> Math.pow(probabilitiesVMP[kk]-probabilitiesISexact[kk],2)/probabilitiesISexact[kk]).average().getAsDouble();
        double meanErrorISVMP = IntStream.range(0, REP).mapToDouble(kk-> Math.pow(probabilitiesISVMP[kk]-probabilitiesISexact[kk],2)/probabilitiesISexact[kk]).average().getAsDouble();
        double meanErrorIS = IntStream.range(0, REP).mapToDouble(kk-> Math.pow(probabilitiesIS[kk]-probabilitiesISexact[kk],2)/probabilitiesISexact[kk]).average().getAsDouble();
