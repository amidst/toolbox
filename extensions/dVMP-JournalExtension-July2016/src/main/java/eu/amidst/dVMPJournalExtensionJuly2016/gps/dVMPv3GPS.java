 ...
 */
public class dVMPv3GPS {

    static Logger logger = LoggerFactory.getLogger(dVMPv3GPS.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        BayesianNetworkWriter.save(LearnedBnet, "./dVMPv2GPS_"+ builder.toString() +".bn");
