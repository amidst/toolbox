 ...
 */
public class StochasticVIGPS {

    static Logger logger = LoggerFactory.getLogger(StochasticVIGPS.class);
    ...
    public static CompoundVector initialize(String[] args) throws FileNotFoundException {
        ...
        CompoundVector vector = parallelVB.getSVB().getPlateuStructure().getPlateauNaturalParameterPosterior()  ;
        return vector;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        BayesianNetworkWriter.save(LearnedBnet, "./StochasticVIGPS_"+ builder.toString() +".bn");
