...
public class DAGsGeneration {
    ...
    public static void generateData(int nVars, int nsamples, int batchsize, String file) throws Exception {
        ...
        DataFlinkWriter.writeDataToARFFFolder(data, file);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int windowSize = 1000;
        generateData(nVars,dataSetSize, windowSize, "./tmpFolder.arff");
