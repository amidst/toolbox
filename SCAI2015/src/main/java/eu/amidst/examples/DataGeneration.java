...
import eu.amidst.examples.core.datastream.DataOnMemoryListContainer;
import eu.amidst.examples.core.datastream.DataStream;
import eu.amidst.examples.core.io.DataStreamLoader;
import eu.amidst.examples.core.io.DataStreamWriter;
...
public class DataGeneration {
    ...
    public static void dataGenerator(String[] args) throws IOException {
        ...
        for (int M = 0; M < 5; M++) {
            ...
            DataStreamWriter.writeDataToFile(dataM, "./data/MPrime_"+M+".arff");
        }
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(DataStreamLoader.loadFromFile("./data/BankArtificialData.arff").stream().count());
    }
}
